...
setversioning() {
    ...
    # For staging branch
    KERNELNAME="${KERNEL}-${KERNELTYPE}-${KERNELRELEASE}-${DEVICE}-oldcam-release-${BUILD_DATE}"
...
# Setver 2 for newcam
setver2() {
    KERNELNAME="${KERNEL}-${KERNELTYPE}-${KERNELRELEASE}-${DEVICE}-newcam-release-${BUILD_DATE}"
